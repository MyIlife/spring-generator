...
public enum FXMLPage {
	...
	/** b端controller param类属性设置页面 */
	SET_PARAM_ATTRIBUTE("FXML/setParamAttribute.fxml"),
	SET_VO_ATTRIBUTE("FXML/setVOAttribute.fxml"),
	/** c端controller param类属性设置页面 */
	SET_PARAM_C_ATTRIBUTE("FXML/setCParamAttribute.fxml"),
	SET_VO_C_ATTRIBUTE("FXML/setCVOAttribute.fxml"),
	/** Service设置页面 */
	...
	SET_ROUTER_C("FXML/SetCRouter.fxml"),
	/** SQL设置页面 */
	...
	/** SQLAssist设置页面 */
	SET_APP_SERVICE("FXML/SetAppService.fxml"),
	/** SQLAssist设置页面 */
