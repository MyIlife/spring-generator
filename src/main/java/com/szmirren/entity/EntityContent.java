...
public class EntityContent {
	 ...
	 * 除id以外的其他属性
	 */
	private List<FieldAttribute> noIdAttrs;
	...
	public List<FieldAttribute> getNoIdAttrs() {
		return noIdAttrs;
	}

	public void setNoIdAttrs(List<FieldAttribute> noIdAttrs) {
		this.noIdAttrs = noIdAttrs;
	}
